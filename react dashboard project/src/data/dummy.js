...
export const stackedChartData = [
  [
     { y: 1, x: 'CS1000' },
     { y: 1, x: 'CS2114Test' },
     { y: 1, x: 'CS3114-Fall-2020' },
     { y: 1, x: 'CS3114-Fall-2020-test' },
     { y: 1, x: 'CS3114-test' },
     { y: 1, x: 'CS3144' },
     { y: 1, x: 'CS3Test' },
     { y: 1, x: 'Data and Algorithm Analysis' },
     {
      y: 1,
      x: 'Data structure and Algorithms - Quicksort'
    },
     {
      y: 1,
      x: 'Data structure and Algorithms - Quicksort Exercises'
    },
     { y: 2, x: 'Data Structures' },
     { y: 4, x: 'Data Structures & Algorithms' },
     {
      y: 1,
      x: 'Data Structures & Algorithms course notes'
    },
     { y: 1, x: 'Data Structures and Algorithms' },
     {
      y: 1,
      x: 'Data Structures and Algorithms (Huss-Lederman)'
    },
     { y: 1, x: 'DeformsKA' },
     { y: 1, x: 'Everything' },
     { y: 1, x: 'Formal Languages' },
     { y: 1, x: 'Introduction to Software Design' },
     { y: 1, x: 'OpenDSA-LTI-Dev3' },
     { y: 1, x: 'samVisFL' },
     { y: 3, x: 'Software Design & Data Structures' },
     { y: 1, x: 'Test Course' }
  ]
  /*[
    { x: 'Jan', y: 111.1 },
